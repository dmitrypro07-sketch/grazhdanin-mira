...
function initTyping() {
  ...
  const texts = ['Шенген, Азия, Америка — под ключ', 'Туристическая, деловая, учебная виза', 'ВНЖ, мультивиза, карта АТЭС', 'Работаем после отказа консульства', 'Срочное оформление от 3 дней', 'Дистанционно из любой точки России'];
