...
function initTyping() {
  ...
  const texts = ['Шенген, Азия, Америка — под ключ', 'Туристическая, деловая, учебная виза', 'ВНЖ, мультивиза, карта АТЭС', 'Работаем после отказа консульства', 'Максимально ускоряем процесс подачи', 'Дистанционно из любой точки России'];
